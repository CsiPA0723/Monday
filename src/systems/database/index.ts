...
import { FoodAttributes, FoodModel } from "./models/food";
...
export function init() {
    ...
    TableFactory("foods", FoodModel);
}

function TableFactory(tableName: "users" | "notes" | "foods", model: ModelAttributes<any> ): void {
...
export function getDataByPk(tableName: "foods", primaryKey: string): FoodAttributes
...
export function deleteDataByPk(tableName: "foods", primaryKey: string): Sqlite.RunResult;
